...
alias ls="ls --all --human-readable --format=long --sort=size --group-directories-first"
alias ll="ls --format=long --human-readable --color=auto"
alias la="ls --format=long --all --human-readable --color=auto"
